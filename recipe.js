class RecipeCalculator {
    constructor() {
        this.recipes = {
            ...
            'chiffon': {
                ...
                ingredients: [
                    ...
                    { name: 'Яйца куриные', amount: 5, unit: 'шт' },
                    { name: 'Растительное масло', amount: 90, unit: 'мл' },
                    { name: 'Вода', amount: 90, unit: 'мл' },
            ...
            'dacquoise': {
                ...
                baseDiameter: 20,
                ingredients: [
                    { name: 'Миндальная мука', amount: 100, unit: 'г' },
                    { name: 'Сахарная пудра', amount: 100, unit: 'г' },
                    { name: 'Белок', amount: 120, unit: 'г' },
            ...
            'joconde': {
                ...
                baseDiameter: 20,
                ingredients: [
                    { name: 'Миндальная мука', amount: 125, unit: 'г' },
                    { name: 'Сахарная пудра', amount: 125, unit: 'г' },
                    { name: 'Яйца куриные', amount: 3, unit: 'шт' },
                    { name: 'Белок', amount: 100, unit: 'г' },
                    { name: 'Сахар', amount: 25, unit: 'г' },
                    { name: 'Мука пшеничная', amount: 25, unit: 'г' },
                    { name: 'Сливочное масло', amount: 30, unit: 'г' }
                ]
            },
            'choux': {
        ...
        this.dryIngredients = ['соль', 'сахар', 'ванильный сахар', 'разрыхлитель', 'ванильный экстракт'];
    }
